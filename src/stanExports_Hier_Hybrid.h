...
namespace model_Hier_Hybrid_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hier_Hybrid");
    reader.add_event(125, 123, "end", "model_Hier_Hybrid");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Hier_Hybrid
  : public stan::model::model_base_crtp<model_Hier_Hybrid> {
private:
        int NE;
        int NF;
        std::vector<int> MT;
...
public:
    model_Hier_Hybrid(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Hier_Hybrid_namespace::model_Hier_Hybrid";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Hier_Hybrid_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Hier_Hybrid_namespace::model_Hier_Hybrid stan_model;
#ifndef USING_R
