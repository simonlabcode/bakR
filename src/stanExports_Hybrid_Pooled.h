...
namespace model_Hybrid_Pooled_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hybrid_Pooled");
    reader.add_event(130, 128, "end", "model_Hybrid_Pooled");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Hybrid_Pooled
  : public stan::model::model_base_crtp<model_Hybrid_Pooled> {
private:
        int NE;
        int NF;
        std::vector<int> MT;
...
public:
    model_Hybrid_Pooled(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Hybrid_Pooled_namespace::model_Hybrid_Pooled";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Hybrid_Pooled_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Hybrid_Pooled_namespace::model_Hybrid_Pooled stan_model;
#ifndef USING_R
