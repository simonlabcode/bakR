...
namespace model_lmtest_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lmtest");
    reader.add_event(19, 17, "end", "model_lmtest");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lmtest
  : public stan::model::model_base_crtp<model_lmtest> {
private:
        int N;
        vector_d x;
        vector_d y;
public:
    model_lmtest(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lmtest_namespace::model_lmtest";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lmtest_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lmtest_namespace::model_lmtest stan_model;
#ifndef USING_R
