...
#include "stanExports_Pooled_Heterosked.h"

RCPP_MODULE(stan_fit4Pooled_Heterosked_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Pooled_Heterosked")
