...
#include "stanExports_Hier_Heterosked.h"

RCPP_MODULE(stan_fit4Hier_Heterosked_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Hier_Heterosked")
