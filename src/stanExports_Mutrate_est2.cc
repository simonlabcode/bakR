...
#include "stanExports_Mutrate_est2.h"

RCPP_MODULE(stan_fit4Mutrate_est2_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_Mutrate_est2")
