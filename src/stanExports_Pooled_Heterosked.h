...
namespace model_Pooled_Heterosked_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Pooled_Heterosked");
    reader.add_event(132, 130, "end", "model_Pooled_Heterosked");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Pooled_Heterosked
  : public stan::model::model_base_crtp<model_Pooled_Heterosked> {
private:
        int NE;
        int NF;
        std::vector<int> TP;
...
public:
    model_Pooled_Heterosked(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Pooled_Heterosked_namespace::model_Pooled_Heterosked";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
                    ...
                    for (int k = 1; k <= nrep; ++k) {
                        ...
                        if (as_bool(logical_eq(j, 1))) {
                            ...
                            stan::model::assign(mu_rep_logit_fn, 
                                        ...
                                        (get_base1(alpha, i, "alpha", 1) + (get_base1(get_base1(sd_rep, i, "sd_rep", 1), j, "sd_rep", 2) * get_base1(get_base1(get_base1(z_fn, i, "z_fn", 1), j, "z_fn", 2), k, "z_fn", 3))), 
                            ...
                            stan::model::assign(mu_rep_logit_fn, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()))), 
                                        ((get_base1(alpha, i, "alpha", 1) + get_base1(get_base1(eff, i, "eff", 1), (j - 1), "eff", 2)) + (get_base1(get_base1(sd_rep, i, "sd_rep", 1), j, "sd_rep", 2) * get_base1(get_base1(get_base1(z_fn, i, "z_fn", 1), j, "z_fn", 2), k, "z_fn", 3))), 
                                        "assigning variable mu_rep_logit_fn");
            ...
            size_t sd_rep_i_0_max__ = NF;
            for (size_t i_0__ = 0; i_0__ < sd_rep_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "sd_rep[i_0__]", sd_rep[i_0__], 0);
            }
            // model body
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Pooled_Heterosked_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_Pooled_Heterosked";
    }
...
typedef model_Pooled_Heterosked_namespace::model_Pooled_Heterosked stan_model;
#ifndef USING_R
