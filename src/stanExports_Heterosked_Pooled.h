...
namespace model_Heterosked_Pooled_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Heterosked_Pooled");
    reader.add_event(131, 129, "end", "model_Heterosked_Pooled");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Heterosked_Pooled
  : public stan::model::model_base_crtp<model_Heterosked_Pooled> {
private:
        int NE;
        int NF;
        std::vector<int> TP;
...
public:
    model_Heterosked_Pooled(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Heterosked_Pooled_namespace::model_Heterosked_Pooled";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Heterosked_Pooled_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_Heterosked_Pooled";
    }
...
typedef model_Heterosked_Pooled_namespace::model_Heterosked_Pooled stan_model;
#ifndef USING_R
