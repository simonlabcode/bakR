...
namespace model_Mut_rate_Model_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Mut_rate_Model");
    reader.add_event(89, 87, "end", "model_Mut_rate_Model");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Mut_rate_Model
  : public stan::model::model_base_crtp<model_Mut_rate_Model> {
private:
        int NE;
        int NF;
        std::vector<int> TP;
...
public:
    model_Mut_rate_Model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Mut_rate_Model_namespace::model_Mut_rate_Model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Mut_rate_Model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Mut_rate_Model_namespace::model_Mut_rate_Model stan_model;
#ifndef USING_R
