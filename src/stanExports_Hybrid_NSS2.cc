...
#include "stanExports_Hybrid_NSS2.h"

RCPP_MODULE(stan_fit4Hybrid_NSS2_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_Hybrid_NSS2")
