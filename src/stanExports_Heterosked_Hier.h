...
namespace model_Heterosked_Hier_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Heterosked_Hier");
    reader.add_event(131, 129, "end", "model_Heterosked_Hier");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Heterosked_Hier
  : public stan::model::model_base_crtp<model_Heterosked_Hier> {
private:
        int NE;
        int NF;
        std::vector<int> TP;
...
public:
    model_Heterosked_Hier(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Heterosked_Hier_namespace::model_Heterosked_Hier";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Heterosked_Hier_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Heterosked_Hier_namespace::model_Heterosked_Hier stan_model;
#ifndef USING_R
