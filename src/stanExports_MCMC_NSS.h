...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_MCMC_NSS");
    reader.add_event(123, 121, "end", "model_MCMC_NSS");
    return reader;
}
#include <stan_meta_header.hpp>
class model_MCMC_NSS
  : public stan::model::model_base_crtp<model_MCMC_NSS> {
private:
        int NE;
        int NF;
        std::vector<int> TP;
...
typedef model_MCMC_NSS_namespace::model_MCMC_NSS stan_model;
#ifndef USING_R
