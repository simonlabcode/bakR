...
#include "stanExports_Heterosked_Hier.h"

RCPP_MODULE(stan_fit4Heterosked_Hier_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Heterosked_Hier")
