...
#include "stanExports_Heterosked_Pooled.h"

RCPP_MODULE(stan_fit4Heterosked_Pooled_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Heterosked_Pooled")
