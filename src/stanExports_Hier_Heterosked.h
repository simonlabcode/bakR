...
namespace model_Hier_Heterosked_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hier_Heterosked");
    reader.add_event(133, 131, "end", "model_Hier_Heterosked");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Hier_Heterosked
  : public stan::model::model_base_crtp<model_Hier_Heterosked> {
private:
        int NE;
        int NF;
        std::vector<int> TP;
...
public:
    model_Hier_Heterosked(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Hier_Heterosked_namespace::model_Hier_Heterosked";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sig_fn", "double", context__.to_vec());
        double sig_fn(0);
        sig_fn = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sig_fn);
        } catch (const std::exception& e) {
        ...
        current_statement_begin__ = 24;
        if (!(context__.contains_r("sig_e")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sig_e missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sig_e");
        pos__ = 0U;
        validate_non_negative_index("sig_e", "(nMT - 1)", (nMT - 1));
        context__.validate_dims("parameter initialization", "sig_e", "vector_d", context__.to_vec((nMT - 1)));
        ...
        for (size_t j_1__ = 0; j_1__ < sig_e_j_1_max__; ++j_1__) {
            sig_e(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lb_unconstrain(0, sig_e);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sig_e: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 25;
        ...
        current_statement_begin__ = 32;
        if (!(context__.contains_r("sd_r_mu")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sd_r_mu missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sd_r_mu");
        pos__ = 0U;
        validate_non_negative_index("sd_r_mu", "nMT", nMT);
        validate_non_negative_index("sd_r_mu", "NF", NF);
        context__.validate_dims("parameter initialization", "sd_r_mu", "vector_d", context__.to_vec(NF,nMT));
        ...
        for (size_t j_1__ = 0; j_1__ < sd_r_mu_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < sd_r_mu_k_0_max__; ++k_0__) {
                sd_r_mu[k_0__](j_1__) = vals_r__[pos__++];
            }
        }
        size_t sd_r_mu_i_0_max__ = NF;
        for (size_t i_0__ = 0; i_0__ < sd_r_mu_i_0_max__; ++i_0__) {
            try {
                writer__.vector_lb_unconstrain(0, sd_r_mu[i_0__]);
            } catch (const std::exception& e) {
                stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sd_r_mu: ") + e.what()), current_statement_begin__, prog_reader__());
            }
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                sig_fn = in__.scalar_lb_constrain(0, lp__);
            else
                sig_fn = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 24;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> sig_e;
            (void) sig_e;  // dummy to suppress unused var warning
            if (jacobian__)
                sig_e = in__.vector_lb_constrain(0, (nMT - 1), lp__);
            else
                sig_e = in__.vector_lb_constrain(0, (nMT - 1));
            current_statement_begin__ = 25;
            ...
            current_statement_begin__ = 32;
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > sd_r_mu;
            size_t sd_r_mu_d_0_max__ = NF;
            sd_r_mu.reserve(sd_r_mu_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < sd_r_mu_d_0_max__; ++d_0__) {
                if (jacobian__)
                    sd_r_mu.push_back(in__.vector_lb_constrain(0, nMT, lp__));
                else
                    sd_r_mu.push_back(in__.vector_lb_constrain(0, nMT));
            }
                    ...
                    for (int k = 1; k <= nrep; ++k) {
                        ...
                        if (as_bool(logical_eq(j, 1))) {
                            ...
                            stan::model::assign(mu_rep_logit_fn, 
                                        ...
                                        (get_base1(alpha, i, "alpha", 1) + (get_base1(get_base1(sd_r_mu, i, "sd_r_mu", 1), j, "sd_r_mu", 2) * get_base1(get_base1(get_base1(z_fn, i, "z_fn", 1), j, "z_fn", 2), k, "z_fn", 3))), 
                            ...
                            stan::model::assign(mu_rep_logit_fn, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()))), 
                                        ((get_base1(alpha, i, "alpha", 1) + get_base1(get_base1(eff, i, "eff", 1), (j - 1), "eff", 2)) + (get_base1(get_base1(sd_r_mu, i, "sd_r_mu", 1), j, "sd_r_mu", 2) * get_base1(get_base1(get_base1(z_fn, i, "z_fn", 1), j, "z_fn", 2), k, "z_fn", 3))), 
                                        "assigning variable mu_rep_logit_fn");
            ...
            lp_accum__.add(lognormal_log<propto__>(sig_fn, -(1), 0.75));
            current_statement_begin__ = 68;
            lp_accum__.add(normal_log<propto__>(alpha, mu_fn, sig_fn));
            current_statement_begin__ = 70;
            lp_accum__.add(lognormal_log<propto__>(sig_e, -(1), 0.7));
            current_statement_begin__ = 71;
            lp_accum__.add(normal_log<propto__>(mu_e, 0, 1));
            current_statement_begin__ = 73;
            lp_accum__.add(normal_log<propto__>(a, 0.5, 0.25));
            current_statement_begin__ = 74;
            lp_accum__.add(normal_log<propto__>(b, -(1), 0.5));
            ...
            lp_accum__.add(lognormal_log<propto__>(sig_rep, -(1), 0.5));
            ...
            for (int i = 1; i <= NF; ++i) {
                ...
                for (int j = 1; j <= nMT; ++j) {
                    ...
                    lp_accum__.add(lognormal_log<propto__>(get_base1(get_base1(sd_r_mu, i, "sd_r_mu", 1), j, "sd_r_mu", 2), get_base1(get_base1(sd_rep, i, "sd_rep", 1), j, "sd_rep", 2), get_base1(sig_rep, j, "sig_rep", 1)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Hier_Heterosked_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double sig_fn = in__.scalar_lb_constrain(0);
        vars__.push_back(sig_fn);
        Eigen::Matrix<double, Eigen::Dynamic, 1> sig_e = in__.vector_lb_constrain(0, (nMT - 1));
        size_t sig_e_j_1_max__ = (nMT - 1);
        for (size_t j_1__ = 0; j_1__ < sig_e_j_1_max__; ++j_1__) {
        ...
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > sd_r_mu;
        size_t sd_r_mu_d_0_max__ = NF;
        sd_r_mu.reserve(sd_r_mu_d_0_max__);
        for (size_t d_0__ = 0; d_0__ < sd_r_mu_d_0_max__; ++d_0__) {
            sd_r_mu.push_back(in__.vector_lb_constrain(0, nMT));
...
typedef model_Hier_Heterosked_namespace::model_Hier_Heterosked stan_model;
#ifndef USING_R
