...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hybrid_NSS2");
    reader.add_event(128, 126, "end", "model_Hybrid_NSS2");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Hybrid_NSS2
  : public stan::model::model_base_crtp<model_Hybrid_NSS2> {
private:
        int NE;
        int NF;
        std::vector<int> MT;
...
typedef model_Hybrid_NSS2_namespace::model_Hybrid_NSS2 stan_model;
#ifndef USING_R
