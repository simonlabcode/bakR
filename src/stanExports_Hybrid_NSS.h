...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hybrid_NSS");
    reader.add_event(111, 109, "end", "model_Hybrid_NSS");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Hybrid_NSS
  : public stan::model::model_base_crtp<model_Hybrid_NSS> {
private:
        int NE;
        int NF;
        std::vector<int> MT;
...
typedef model_Hybrid_NSS_namespace::model_Hybrid_NSS stan_model;
#ifndef USING_R
