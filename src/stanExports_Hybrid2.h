...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hybrid2");
    reader.add_event(116, 114, "end", "model_Hybrid2");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Hybrid2
  : public stan::model::model_base_crtp<model_Hybrid2> {
private:
        int NE;
        int NF;
        std::vector<int> MT;
...
typedef model_Hybrid2_namespace::model_Hybrid2 stan_model;
#ifndef USING_R
