...
namespace model_Hybrid_Hier_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Hybrid_Hier");
    reader.add_event(124, 122, "end", "model_Hybrid_Hier");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Hybrid_Hier
  : public stan::model::model_base_crtp<model_Hybrid_Hier> {
private:
        int NE;
        int NF;
        std::vector<int> MT;
...
public:
    model_Hybrid_Hier(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Hybrid_Hier_namespace::model_Hybrid_Hier";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 26;
        if (!(context__.contains_r("sd_rep")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sd_rep missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sd_rep");
        pos__ = 0U;
        validate_non_negative_index("sd_rep", "nMT", nMT);
        context__.validate_dims("parameter initialization", "sd_rep", "vector_d", context__.to_vec(nMT));
        Eigen::Matrix<double, Eigen::Dynamic, 1> sd_rep(nMT);
        size_t sd_rep_j_1_max__ = nMT;
        for (size_t j_1__ = 0; j_1__ < sd_rep_j_1_max__; ++j_1__) {
            sd_rep(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lb_unconstrain(0, sd_rep);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sd_rep: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 27;
        if (!(context__.contains_r("z_rep")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable z_rep missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("z_rep");
        pos__ = 0U;
        validate_non_negative_index("z_rep", "nMT", nMT);
        validate_non_negative_index("z_rep", "NF", NF);
        context__.validate_dims("parameter initialization", "z_rep", "vector_d", context__.to_vec(NF,nMT));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > z_rep(NF, Eigen::Matrix<double, Eigen::Dynamic, 1>(nMT));
        size_t z_rep_j_1_max__ = nMT;
        size_t z_rep_k_0_max__ = NF;
        for (size_t j_1__ = 0; j_1__ < z_rep_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < z_rep_k_0_max__; ++k_0__) {
                z_rep[k_0__](j_1__) = vals_r__[pos__++];
            }
        }
        size_t z_rep_i_0_max__ = NF;
        for (size_t i_0__ = 0; i_0__ < z_rep_i_0_max__; ++i_0__) {
            try {
                writer__.vector_unconstrain(z_rep[i_0__]);
            } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 26;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> sd_rep;
            (void) sd_rep;  // dummy to suppress unused var warning
            if (jacobian__)
                sd_rep = in__.vector_lb_constrain(0, nMT, lp__);
            else
                sd_rep = in__.vector_lb_constrain(0, nMT);
            current_statement_begin__ = 27;
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > z_rep;
            size_t z_rep_d_0_max__ = NF;
            z_rep.reserve(z_rep_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < z_rep_d_0_max__; ++d_0__) {
                if (jacobian__)
                    z_rep.push_back(in__.vector_constrain(nMT, lp__));
                else
            ...
            lp_accum__.add(normal_log<propto__>(log_sig_fn, -(1), 0.5));
            current_statement_begin__ = 65;
            lp_accum__.add(normal_log<propto__>(alpha, mu_fn, sig_fn));
            current_statement_begin__ = 67;
            lp_accum__.add(normal_log<propto__>(log_sig_e, -(1), 0.5));
            ...
            lp_accum__.add(lognormal_log<propto__>(sd_rep, -(2), 0.25));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Hybrid_Hier_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> sd_rep = in__.vector_lb_constrain(0, nMT);
        size_t sd_rep_j_1_max__ = nMT;
        for (size_t j_1__ = 0; j_1__ < sd_rep_j_1_max__; ++j_1__) {
            vars__.push_back(sd_rep(j_1__));
        }
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > z_rep;
        size_t z_rep_d_0_max__ = NF;
        z_rep.reserve(z_rep_d_0_max__);
        for (size_t d_0__ = 0; d_0__ < z_rep_d_0_max__; ++d_0__) {
            z_rep.push_back(in__.vector_constrain(nMT));
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < sd_rep_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "sd_rep" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t z_rep_j_1_max__ = nMT;
        size_t z_rep_k_0_max__ = NF;
        for (size_t j_1__ = 0; j_1__ < z_rep_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < z_rep_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "z_rep" << '.' << k_0__ + 1 << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t eff_j_1_max__ = (nMT - 1);
...
typedef model_Hybrid_Hier_namespace::model_Hybrid_Hier stan_model;
#ifndef USING_R
