...
sim_data <- sim_DynamicSeqData(100)
  # This will simulate 100 features, 2 experimental conditions
  # and 3 replicates for each experimental condition
  # See ?simDynamicSeqData for details regarding tunable parameters
...
"But didn't you say that all other models require the output of fast_analysis() to run? Won't poor mutation rate estimates at this stage bias all downstream models?" Wow, another great question! The short answer is no. The slightly longer answer is no for one set of models and yes for the other, but you can eliminate all bias thanks to the unaffected models. 
