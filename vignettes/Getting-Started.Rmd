...
# Run Hybrid model (This might take a minute or two to run)
...
L2FC(kdeg) heatmaps (will require a separate function from another package to actually generate the
heatmaps):

```{r}
## Make matrix that can be passed to heatmap functions
